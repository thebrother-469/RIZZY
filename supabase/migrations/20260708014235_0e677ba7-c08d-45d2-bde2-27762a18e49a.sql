...
CREATE UNIQUE INDEX IF NOT EXISTS subscriptions_paddle_sub_uniq ON public.subscriptions(paddle_subscription_id) WHERE paddle_subscription_id IS NOT NULL;
