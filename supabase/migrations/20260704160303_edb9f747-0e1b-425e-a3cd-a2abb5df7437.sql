...
CREATE TABLE public.profiles (
  ...
  social_challenges TEXT[] DEFAULT '{}',
...
CREATE POLICY "own sub update" ON public.subscriptions FOR UPDATE TO authenticated USING (auth.uid() = user_id) WITH CHECK (auth.uid() = user_id);
